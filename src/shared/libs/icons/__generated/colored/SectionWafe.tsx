...
export const SectionWafeIcon = React.memo(
  ({
    size = 24,
    color = "#4E5361",
    ...props
    ...
    return (
      <svg width={size} height={size} fill="none" {...props}>
        <path
          ...
          fill="url(#section-wafe_svg__a)"
        />
        <path
          d="M0 25.78c261-79.003 480.5 134.504 914.5 75.002C1210 39.28 1344.5-27.222 1536 12.28v3729.11H0V25.78z"
          fill="url(#section-wafe_svg__b)"
        />
        <path
          d="M0 25.78c261-79.003 480.5 134.504 914.5 75.002C1210 39.28 1344.5-27.222 1536 12.28v3729.11H0V25.78z"
          fill="url(#section-wafe_svg__c)"
        />
        <defs>
          <radialGradient
            id="section-wafe_svg__b"
            cx={0}
            cy={0}
            r={1}
...
SectionWafeIcon.displayName = "SectionWafeIcon";
