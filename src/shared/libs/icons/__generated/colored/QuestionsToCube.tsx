...
export const QuestionsToCubeIcon = React.memo(
  ({
    size = 24,
    color = "#4E5361",
    ...props
    ...
    return (
      <svg width={size} height={size} fill="none" {...props}>
        <path
          ...
          stroke="url(#questions-to-cube_svg__a)"
          strokeWidth={2.788}
        />
        <g filter="url(#questions-to-cube_svg__b)">
          <path
            ...
            fill="url(#questions-to-cube_svg__c)"
          />
          <path
            ...
            fill="url(#questions-to-cube_svg__d)"
          />
        </g>
        <g filter="url(#questions-to-cube_svg__e)">
          <path
            ...
            fill="url(#questions-to-cube_svg__f)"
          />
          <path
            ...
            fill="url(#questions-to-cube_svg__g)"
          />
        </g>
        <defs>
          <linearGradient
            id="questions-to-cube_svg__a"
            x1={133.969}
            y1={6.571}
            x2={40.129}
            y2={162.37}
...
QuestionsToCubeIcon.displayName = "QuestionsToCubeIcon";
